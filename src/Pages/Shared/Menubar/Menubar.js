...
const Menubar = () => {
    ...
    <React.Fragment>
      <li>
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "text-slate-900 rounded font-semibold text-sm"
  ...
  return (
    <div class="px-4 py-5 mx-auto md:px-24 lg:px-8 bg-slate-50">
      <div class="relative flex container mx-auto items-center justify-between">
        <Link to="/">
          <span class="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">
            String Symphony
          </span>
        </Link>
        <ul class="items-center hidden space-x-8 lg:flex">{menuItems}</ul>
